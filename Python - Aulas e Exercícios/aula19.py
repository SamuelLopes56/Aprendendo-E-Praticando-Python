...
while x < 10:
    if x == 3:
        x = x + 1
        continue  # Quando tiver a palacra "continue" ele não executa o código abaixo da palavra ( contanto que esteja no mesmo escopo que a palavra foi usada, nesse caso no escopo do if )
